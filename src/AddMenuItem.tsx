  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="Areas__HeaderArea-sc-8gfrea-3 HeaderArea">
          <div className="Areas__InteractiveArea-sc-8gfrea-0 Areas__Column-sc-8gfrea-5 bJSfgC Column-lg">
            <p
              className="e-91000-text encore-text-body-medium-bold ListRowTitle__ListRowText-sc-1xe2if1-1"
              id="listrow-title-global-create-youtube"
            >
              Add From Youtube
            </p>
            <p
              className="e-91000-text encore-text-body-small encore-internal-color-text-subdued ListRowDetails__ListRowDetailText-sc-sozu4l-0"
